            ...
            while (shouldContinue)
            {
                ...
                switch (charactersChoice)
                {
                    case 1:
                        ...
                        break;
                    case 2:
                        newCharacter = new Scavenger(name, age, height, weight, classificationChoice, speciesChoice, weaponChoice);
                        break;
                    case 3:
                        newCharacter = new SithLord(name, age, height, weight, classificationChoice, speciesChoice, weaponChoice);
                        break;
                    case 4:
                        newCharacter = new Scoundrel(name, age, height, weight, classificationChoice, speciesChoice, weaponChoice);
                        break;
                    case 5:
                        newCharacter = new StormTrooper(name, age, height, weight, classificationChoice, speciesChoice, weaponChoice);
                        break;
                    case 6:
                        newCharacter = new Politician(name, age, height, weight, classificationChoice, speciesChoice, weaponChoice);
                        break;
                    case 7:
                        newCharacter = new MobBoss(name, age, height, weight, classificationChoice, speciesChoice, weaponChoice);
                        break;
                    default:
                        newCharacter = new StormTrooper(name, age, height, weight, classificationChoice, speciesChoice, weaponChoice);
                        break;
