...
namespace StarWarsCharacterModels.Characters
{
    ...
    {
        public StormTrooper(string name, int age, double height, double weight, int classificationChoice, int speciesChoice, int weaponChoice, bool canHaveTheForce, bool mustHaveTheForce) :
